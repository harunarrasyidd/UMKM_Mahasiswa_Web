...
$query1 = "SELECT * FROM akun WHERE id = $id";
...
// Fetch data pengguna yang akan diedit
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            ...
                            <form class="form" method="post" action="edit_user1.php">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="nama" type="text" placeholder="" value="<?= $data['nama'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            <label>Type<span>*</span></label>
                                            <input name="type" type="text" placeholder="" value="<?= $data['type'] ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12" hidden>
                                        <div class="form-group">
                                            ...
                                            <input name="lvl" type="text" placeholder="" value="<?= $data['lvl'] ?>"
                                                readonly>
                                        </div>
                                    </div>
