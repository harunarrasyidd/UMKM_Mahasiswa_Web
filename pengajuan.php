...
$queryCheckLaporan = "SELECT * FROM laporan WHERE nama='$nama'";
$resultCheckLaporan = mysqli_query($conn, $queryCheckLaporan);
$alreadySubmitted = mysqli_num_rows($resultCheckLaporan) > 0;

// Jika pengguna sudah mengirimkan laporan, alihkan kembali ke laporan.php
if ($alreadySubmitted) {
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="indexs.php"><img src="../assets/ourumkm_logo.png" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													<li class=""><a href="indexs.php">OurUMKM</a></li>
													<li class="active"><a href="pengajuan.php">Pengajuan</a></li>
													<li class=""><a href="laporan.php">Laporan</a></li>
												</ul>
										</div>
									</div>
								</nav>
					...
					<div class="row">
						<div class="col-lg-8 col-12">
							<div class="form-main">
								...
								<form class="form" method="post" action="pengajuan1.php">
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Nama Anda<span>*</span></label>
												<input name="nama" type="text" placeholder="" value="<?php echo $_SESSION['user']; ?>" readonly>
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Toko<span>*</span></label>
												<input name="toko" type="text" placeholder="">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<select name="type" class="form-group">
                    								...
                    								<option value="makanan" class="form-group">Makanan</option>
                    								<option value="pakaian" class="form-group">pakaian</option>
												</select>
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="nama_produk" type="text" placeholder="">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Harga<span>*</span></label>
												<input name="harga" type="text" placeholder=""></input>
											</div>
										</div>
										<div class="col-lg-6 col-12" hidden>
											<div class="form-group">
												<label>Status<span>*</span></label>
												<input name="status" type="text" placeholder="" value="Menunggu"></input>
											</div>
										</div>
										<div class="col-12">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li>UIN WALISONGO, SEMARANG. IINDONESIA</li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="indexs.php"><img src="../assets/ourumkm_logo.png" alt="#"></a>
							</div>
