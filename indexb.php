            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="indexb.php"><img src="../assets/ourumkm_logo.png" alt="logo"></a>
                        </div>
                        <!--/ End Logo -->
                        <!-- Search Form -->
                            ...
                            <div class="navbar-collapse">
                                <div class="nav-inner">
                                    <ul class="nav main-menu menu navbar-nav">
                                        <li class="active"><a href="indexb.php">OurUMKM</a></li>
                                        <li><a href="#">Belanja<i class="ti-angle-down"></i><span
                                                ...
                                                <div class="product-img">
                                                    ...
                                                    <div class="button-head">
                                                        ...
                                                        <div class="product-action-2">
                                                            <button class="tambah-ke-keranjang"
                                                                data-nama="<?php echo $rowMakanan['nama_produk']; ?>"
                                                                data-harga="<?php echo $rowMakanan['harga']; ?>"
                                                                data-gambar="../assets/makanan/<?php echo $rowMakanan['gambar']; ?>">Tambah
                                                                ke Keranjang</button>
                                                        </div>
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="button-head">
                                                        ...
                                                        <div class="product-action-2">
                                                            <button class="tambah-ke-keranjang"
                                                                data-nama="<?php echo $rowPakaian['nama_produk']; ?>"
                                                                data-harga="<?php echo $rowPakaian['harga']; ?>"
                                                                data-gambar="../assets/pakaian/<?php echo $rowPakaian['gambar']; ?>">Tambah
                                                                ke Keranjang</button>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        ...
                        <div class="single-footer about">
                            <div class="logo">
                                <a href="indexb.php"><img src="../assets/ourumkm_logo.png" alt="#"></a>
                            </div>
