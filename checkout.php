			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="indexa.php"><img src="logo uin.png" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget get-button">
								<div class="content">
									<div class="button">
										<a href="selamat.php" class="btn">proceed to checkout</a>
									</div>
								</div>
							</div>
							<!--/ End Button Widget -->
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-5 col-md-6 col-12">
							...
							<div class="single-footer about">
								<div class="logo">
									<a href="indexa.php"><img src="logo uin.png" alt="#"></a>
								</div>
					...
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							<h4>Informasi</h4>
							<ul>
								<li><a href="data_barang.php">Daftar Barang</a></li>
