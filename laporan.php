...
$query = "SELECT * FROM laporan WHERE nama='$nama'";
                            ...
                            <div class="navbar-collapse">
                                <div class="nav-inner">
                                    <ul class="nav main-menu menu navbar-nav">
                                        ...
                                        <li class=""><a href="pengajuan.php">Pengajuan</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="nama" type="text" placeholder="<?php echo $data['nama']; ?>"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="toko" type="text" placeholder="<?php echo $data['toko']; ?>"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="type" type="text" placeholder="<?php echo $data['type']; ?>"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="nama_produk" type="text"
                                                placeholder="<?php echo $data['nama_produk']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            <label>Harga<span>*</span></label>
                                            <input name="harga" type="text" placeholder="<?php echo $data['harga']; ?>"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="status" type="text"
                                                placeholder="<?php echo $data['status']; ?>" disabled>
                                        </div>
                                    </div>
                                    <?php else : ?>
                                    <div class="col-12">
