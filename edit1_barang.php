...
$query = "SELECT * FROM data_pakaian WHERE id='$id'";
                            ...
                            <div class="navbar-collapse">
                                <div class="nav-inner">
                                    <ul class="nav main-menu menu navbar-nav">
                                        ...
                                        <li class=""><a href="validasi.php">Validasi</a></li>
                                        <li class="active"><a href="data_barang.php">Barang</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            <div class="title">
                                <h4>Edit</h4>
                                <h3>Barang Produk UMKM</h3>
                            </div>
                            <form class="form" method="post" action="edit_barang1.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6 col-12" hidden>
                                        <div class="form-group">
                                            <label>Id<span>*</span></label>
                                            <input name="id" type="text" placeholder="" value="<?= $data['id'] ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <select name="type">
                                                <option value="makanan"
                                                    <?= ($data['type'] == 'makanan') ? 'selected' : ''; ?>>Makanan
                                                </option>
                                                <option value="pakaian"
                                                    <?= ($data['type'] == 'pakaian') ? 'selected' : ''; ?>>Pakaian
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="harga" type="text" placeholder=""
                                                value="<?= $data['harga'] ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="single-head">
                            <div class="single-info">
                                ...
                                <ul>
                                    <li>+62 456-789-1120</li>
                                    <li>+62 672-452-1120</li>
                                </ul>
                            </div>
                            <div class="single-info">
