                                ...
                                <div class="row">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-bold-500"><?= $data['password'] ?></td>

                                                <td class="text-bold-500">
                                                    <a href="edit_user.php?id=<?=$data['id']?>" class="btn btn-sm btn-Success">Edit</a>
                                                </td>
                                                <td class="text-bold-500">
                                                    <?php if ($data['type'] !== 'admin') { ?>
                                                    <a href="tambah_user1.php?del&id=<?= $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</a>
                                                    <?php } ?>
                                                </td>
                                    ...
                                    <div class="col-10">
                                        <div class="form-group button">
                                            <a href="tambah_user.php" class="btn btn-sm btn-Success">Tambah User</a>
                                        </div>
                                    </div>
                                </div>
