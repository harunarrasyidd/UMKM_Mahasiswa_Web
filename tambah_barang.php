...
$dataLab = mysqli_fetch_assoc($result);
?>
<!DOCTYPE html>
<html lang="zxx">
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            ...
                            <form class="form" method="post" action="tambah_barang1.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            <label>Type<span>*</span></label>
                                            <input name="type" type="text" placeholder="" value="<?= $type ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12" >
                                        <div class="form-group">
                                            ...
                                            <input name="harga" type="text" placeholder="" value="<?= $harga ?>" readonly>
                                        </div>
                                    </div>
